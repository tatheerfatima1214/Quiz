...
if ( ! defined( 'PIEREGISTER_VERSION' ) ) {
	define( 'PIEREGISTER_VERSION', '3.7.0.2' );
}
	...
	class PieRegister extends PieReg_Base{
		...
		*/
		...
		function piereg_register_scripts(){
			...
			wp_register_script('pie_sidr_js',plugins_url("/assets/js/jquery.sidr.min.js",__FILE__),'jquery',PIEREGISTER_VERSION,false);
		...
		*/
		...
		private function show_invitaion_code_user(){
			...
			$inv_code = base64_decode(trim($_GET['invitaion_code']));
